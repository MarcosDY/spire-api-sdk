...
type LocalAuthorityClient interface {
	...
	// ReactivateX509Authority reactivates the previously activate JWT authority
	//
	// If previously active JWT authority does not exist or it should rotate,
	// a Failed Precondition error will be returned
	ReactivateJWTAuthoriry(ctx context.Context, in *ReactivateJWTAuthorityRequest, opts ...grpc.CallOption) (*ReactivateJWTAuthorityResponse, error)
	...
	// ReactivateX509Authority reactivates the previously activate X.509 authority
	//
	// If previously active X.509 authority does not exist or it should rotate,
	// a Failed Precondition error will be returned
	ReactivateX509Authoriry(ctx context.Context, in *ReactivateX509AuthorityRequest, opts ...grpc.CallOption) (*ReactivateX509AuthorityResponse, error)
}
...
func (c *localAuthorityClient) ReactivateJWTAuthoriry(ctx context.Context, in *ReactivateJWTAuthorityRequest, opts ...grpc.CallOption) (*ReactivateJWTAuthorityResponse, error) {
	out := new(ReactivateJWTAuthorityResponse)
	err := c.cc.Invoke(ctx, "/spire.api.server.localauthority.v1.LocalAuthority/ReactivateJWTAuthoriry", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *localAuthorityClient) ReactivateX509Authoriry(ctx context.Context, in *ReactivateX509AuthorityRequest, opts ...grpc.CallOption) (*ReactivateX509AuthorityResponse, error) {
	out := new(ReactivateX509AuthorityResponse)
	err := c.cc.Invoke(ctx, "/spire.api.server.localauthority.v1.LocalAuthority/ReactivateX509Authoriry", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LocalAuthorityServer interface {
	...
	// If previously active JWT authority does not exist or it should rotate,
	// a Failed Precondition error will be returned
	ReactivateJWTAuthoriry(context.Context, *ReactivateJWTAuthorityRequest) (*ReactivateJWTAuthorityResponse, error)
	// GetX509AuthorityState returns the state of all locally configured
	// X.509 authorities.
	...
	// If previously active X.509 authority does not exist or it should rotate,
	// a Failed Precondition error will be returned
	ReactivateX509Authoriry(context.Context, *ReactivateX509AuthorityRequest) (*ReactivateX509AuthorityResponse, error)
...
func (UnimplementedLocalAuthorityServer) ReactivateJWTAuthoriry(context.Context, *ReactivateJWTAuthorityRequest) (*ReactivateJWTAuthorityResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReactivateJWTAuthoriry not implemented")
}
...
func (UnimplementedLocalAuthorityServer) ReactivateX509Authoriry(context.Context, *ReactivateX509AuthorityRequest) (*ReactivateX509AuthorityResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReactivateX509Authoriry not implemented")
}
...
func _LocalAuthority_ReactivateJWTAuthoriry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReactivateJWTAuthorityRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LocalAuthorityServer).ReactivateJWTAuthoriry(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/spire.api.server.localauthority.v1.LocalAuthority/ReactivateJWTAuthoriry",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LocalAuthorityServer).ReactivateJWTAuthoriry(ctx, req.(*ReactivateJWTAuthorityRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _LocalAuthority_ReactivateX509Authoriry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReactivateX509AuthorityRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LocalAuthorityServer).ReactivateX509Authoriry(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/spire.api.server.localauthority.v1.LocalAuthority/ReactivateX509Authoriry",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LocalAuthorityServer).ReactivateX509Authoriry(ctx, req.(*ReactivateX509AuthorityRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _LocalAuthority_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ReactivateJWTAuthoriry",
			Handler:    _LocalAuthority_ReactivateJWTAuthoriry_Handler,
		},
		{
		...
		{
			MethodName: "ReactivateX509Authoriry",
			Handler:    _LocalAuthority_ReactivateX509Authoriry_Handler,
		},
	},
